...
while True:
    ...
    choice = int(input("Изберете действие: "))

    match choice:
        case 1:
            name = input("Въведете име: ")
            phone = input("Въведете телефон: ")
            phone_book[name] = phone
            print("Записът е добавен")
        case 2:
            name = input("Въведете име: ")
            phone = phone_book.get(name, None)
            print(phone)
        case 3:
            name = input("Въведете име: ")
            phone = input("Въведете нов телефон: ")
            phone_book[name] = phone
            print("Записът е променен")
        case 4:
            name = input("Въведете име: ")
            phone = phone_book.pop(name, None)
            if phone:
                print("Записът е изтрит")
            else:
                print("Записът не е намерен")
        case 5:
